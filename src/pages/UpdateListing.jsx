...
export default function CreateListing() {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const res = await fetch(`https://cozycorner-backend.onrender.com/api/listing/get/${listingId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      setError(false);
      const res = await fetch(`https://cozycorner-backend.onrender.com/api/listing/update/${params.listingId}`, {
        method: 'POST',
        headers: {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      <h1 className='text-3xl text-slate-500 font-semibold text-center my-7'>
        Update a Listing
      </h1>
