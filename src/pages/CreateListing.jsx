      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex flex-wrap gap-4'>
            ...
            {imageUploadError && (
              <div className='w-full'>
                <p className='text-red-900'>{imageUploadError}</p>
              </div>
            )}
            {formData.imageUrls.map((imageUrl, index) => (
              ...
              >
                ...
                <button
                  type='button'
                  className='absolute top-0 right-0 bg-red-900 text-white p-1 rounded-full'
          ...
          <div className='flex flex-col items-center justify-between gap-5 mt-4'>
            <button
              type='submit'
              className='px-8 py-4 bg-slate-500 rounded-md text-white w-full'
              disabled={loading}
            >
